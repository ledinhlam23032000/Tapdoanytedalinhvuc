...
### 52 ADR — `docs/architecture/DECISIONS.md:<dòng>`
...
`:1132` ADR-052 — Dữ liệu lâm sàng KHÔNG dùng application-level fiel…

### Prisma `prisma/schema.prisma` — 45 model, 50 enum

**Model** User`:29` · Ecosystem`:103` · EcosystemMembership`:130` · Company`:161` · CompanyMembership`:231` · AuditEvent`:252` · OrganizationUnit`:300` · Position`:336` · Assignment`:356` · WorkItem`:393` · Project`:445` · ProjectMembership`:479` · CustomerSource`:510` · Lead`:534` · Customer`:577` · CustomerInteraction`:626` · Appointment`:651` · CatalogItem`:687` · Sale`:724` · SaleLine`:761` · Payment`:830` · Expense`:875` · LedgerEntry`:926` · PayrollProfile`:963` · PayrollRun`:988` · PayrollItem`:1016` · ApprovalRequest`:1054` · CommissionRule`:1096` · CommissionCalculation`:1120` · InventoryLocation`:1150` · InventoryItem`:1169` · StockMovement`:1218` · CompanyModule`:1270` · MedicalCase`:1304` · HealthcareAppointmentContext`:1345` · ClinicalConsultation`:1367` · ClinicalConsultationAddendum`:1394` · ClinicalScreeningItem`:1418` · Procedure`:1445` · ProcedureMaterialUsage`:1489` · ConsentTemplate`:1530` · ConsentRecord`:1556` · ClinicalPhoto`:1602` · MedicalFollowUp`:1643` · CompanyMembershipPack`:1682`

**Enum** UserStatus`:23` · EcosystemStatus`:97` · EcosystemRolePreset`:118` · MembershipStatus`:125` · CompanyType`:148` · CompanyStatus`:154` · CompanyRolePreset`:223` · OrgUnitType`:287` · ArchivableStatus`:295` · AssignmentStatus`:351` · WorkItemStatus`:379` · WorkItemPriority`:386` · ProjectStatus`:436` · ProjectRolePreset`:473` · LeadStatus`:526` · CustomerStatus`:559` · CustomerJourneyStage`:567` · CustomerInteractionType`:615` · AppointmentStatus`:643` · CatalogItemType`:682` · SaleStatus`:718` · PaymentMethod`:817` · PaymentStatus`:825` · ExpenseCategory`:856` · ExpenseSourceType`:865` · ExpenseStatus`:870` · LedgerEntryType`:904` · LedgerSourceType`:913` · LedgerEntryStatus`:921` · PayrollPayType`:959` · PayrollRunStatus`:980` · ApprovalActionType`:1036` · ApprovalRequestStatus`:1041` · CommissionRuleType`:1084` · CommissionRuleStatus`:1090` · InventoryLocationType`:1144` · StockMovementType`:1198` · StockMovementSourceType`:1207` · CompanyModuleType`:1264` · MedicalCaseStatus`:1285` · MedicalCaseType`:1293` · ClinicalRecordStatus`:1360` · ScreeningAnswer`:1413` · ProcedureStatus`:1435` · ProcedureMaterialUsageStatus`:1481` · ConsentType`:1513` · ConsentStatus`:1521` · ClinicalPhotoType`:1589` · MedicalFollowUpStatus`:1632` · PermissionPack`:1675`
