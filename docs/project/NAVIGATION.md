...
### Prisma `prisma/schema.prisma` — 44 model, 49 enum

**Model** User`:29` · Ecosystem`:102` · EcosystemMembership`:129` · Company`:160` · CompanyMembership`:230` · AuditEvent`:249` · OrganizationUnit`:297` · Position`:333` · Assignment`:353` · WorkItem`:390` · Project`:442` · ProjectMembership`:476` · CustomerSource`:507` · Lead`:531` · Customer`:574` · CustomerInteraction`:623` · Appointment`:648` · CatalogItem`:684` · Sale`:711` · SaleLine`:748` · Payment`:817` · Expense`:862` · LedgerEntry`:913` · PayrollProfile`:950` · PayrollRun`:975` · PayrollItem`:1003` · ApprovalRequest`:1041` · CommissionRule`:1083` · CommissionCalculation`:1107` · InventoryLocation`:1137` · InventoryItem`:1156` · StockMovement`:1205` · CompanyModule`:1257` · MedicalCase`:1291` · HealthcareAppointmentContext`:1332` · ClinicalConsultation`:1354` · ClinicalConsultationAddendum`:1381` · ClinicalScreeningItem`:1405` · Procedure`:1432` · ProcedureMaterialUsage`:1476` · ConsentTemplate`:1517` · ConsentRecord`:1543` · ClinicalPhoto`:1589` · MedicalFollowUp`:1630`

**Enum** UserStatus`:23` · EcosystemStatus`:96` · EcosystemRolePreset`:117` · MembershipStatus`:124` · CompanyType`:147` · CompanyStatus`:153` · CompanyRolePreset`:222` · OrgUnitType`:284` · ArchivableStatus`:292` · AssignmentStatus`:348` · WorkItemStatus`:376` · WorkItemPriority`:383` · ProjectStatus`:433` · ProjectRolePreset`:470` · LeadStatus`:523` · CustomerStatus`:556` · CustomerJourneyStage`:564` · CustomerInteractionType`:612` · AppointmentStatus`:640` · CatalogItemType`:679` · SaleStatus`:705` · PaymentMethod`:804` · PaymentStatus`:812` · ExpenseCategory`:843` · ExpenseSourceType`:852` · ExpenseStatus`:857` · LedgerEntryType`:891` · LedgerSourceType`:900` · LedgerEntryStatus`:908` · PayrollPayType`:946` · PayrollRunStatus`:967` · ApprovalActionType`:1023` · ApprovalRequestStatus`:1028` · CommissionRuleType`:1071` · CommissionRuleStatus`:1077` · InventoryLocationType`:1131` · StockMovementType`:1185` · StockMovementSourceType`:1194` · CompanyModuleType`:1251` · MedicalCaseStatus`:1272` · MedicalCaseType`:1280` · ClinicalRecordStatus`:1347` · ScreeningAnswer`:1400` · ProcedureStatus`:1422` · ProcedureMaterialUsageStatus`:1468` · ConsentType`:1500` · ConsentStatus`:1508` · ClinicalPhotoType`:1576` · MedicalFollowUpStatus`:1619`
